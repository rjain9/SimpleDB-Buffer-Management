...
public class BufferTest{
	public static void main(String args[]) throws Exception {
		...
		System.out.println("8 blocks pinned successfully!");
		  bfr.bufferMgr.bufferPoolMap.get(blklist[2]).setInt(2, 1, 5, 30);
	      ...
	      bfr.bufferMgr.bufferPoolMap.get(blklist[7]).setInt(2, 1, 15, 80);
	      bfr.pin(blklist[2]);
	      System.out.println(bfr.bufferMgr.bufferPoolMap.get(blklist[2]).isPinned());
	      bfr.bufferMgr.printBufferMap();
	      bfr.unpin(bfr.bufferMgr.bufferPoolMap.get(blklist[7]));
	      bfr.bufferMgr.printBufferMap();
	      bfr.pin(blklist[5]);
